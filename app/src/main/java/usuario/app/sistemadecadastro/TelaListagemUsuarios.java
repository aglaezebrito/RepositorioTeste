...
import usuario.app.sistemadecadastro.TelaPrincipal;
import usuario.app.sistemadecadastro.TelaPrincipalActivity;
...
public class TelaListagemUsuarios {
    ...
    int index;
    public TelaListagemUsuarios(TelaPrincipalActivity act, TelaPrincipal
            tela_principal) {
        this.act = act;
